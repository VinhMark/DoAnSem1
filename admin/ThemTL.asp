...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.TheLoai (TenTL) VALUES (?)" 
    MM_editCmd.Prepared = true
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param1", 202, 1, 50, Request.Form("txtThemTL")) ' adVarWChar
    MM_editCmd.Execute
    MM_editCmd.ActiveConnection.Close

    ' append the query string to the redirect URL
    Dim MM_editRedirectUrl
    MM_editRedirectUrl = "ThemTL.asp"
    If (Request.QueryString <> "") Then
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row"><!-- InstanceBeginEditable name="nội dung" -->
			   <table class="theten" width="98%" height="30px"><td>Thêm Thể Loại</td></table>		    
			    <div class="noidung">
			    <form id="form1" name="form1" method="POST" action="<%=MM_editAction%>">
                  ...
                  <table class="thethongtin" width="98%" border="0" cellspacing="0" cellpadding="0">
			        <tr>
			          <td>Thêm Thể Loại</td>
			          <td><label for="txtThemTL"></label>
		              <input type="text" name="txtThemTL" id="txtThemTL" /></td>
		            </tr>
			        <tr>
