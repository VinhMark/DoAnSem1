...
KhachHang_cmd.ActiveConnection = MM_connect_STRING
KhachHang_cmd.CommandText = "SELECT * FROM dbo.KhachHang ORDER BY MaKH DESC" 
...
Repeat1__numRows = -1
Repeat1__index = 0
KhachHang_numRows = KhachHang_numRows + Repeat1__numRows
%>
			    ...
			    <div class="col-lg-9 col-md-12">	
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-flag-o red"></i><strong>Tài khoản khách hàng</strong></h2>
						</div>
						<div class="panel-body">
							<table class="table bootstrap-datatable countries">
								...
								<tbody>
                                  <% 
While ((Repeat1__numRows <> 0) AND (NOT KhachHang.EOF)) 
%>
  <tr>
    <td><%=(KhachHang.Fields.Item("TenKH").Value)%></td>
    <td><%=(KhachHang.Fields.Item("TaiKhoan").Value)%></td>
