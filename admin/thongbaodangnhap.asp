...
MM_valUsername = CStr(Request.Form("txtTenTK"))
If MM_valUsername <> "" Then
  ...
  MM_redirectLoginSuccess = "XemSach.asp"
  ...
  MM_rsUser_cmd.Parameters.Append MM_rsUser_cmd.CreateParameter("param2", 200, 1, 50, Request.Form("txtMK")) ' adVarChar
...
<head>
    ...
    <style type="text/css">
    .login-img3-body .container .login-form .login-wrap table tr td {
	color: #FF0000;
}
    </style>
      ...
      <form METHOD="POST" class="login-form" action="<%=MM_LoginAction%>">        
        <div class="login-wrap">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center">Đăng nhập thất bại! ,vui lòng đăng nhập lại!</td>
            </tr>
          </table>
          <p class="login-img">&nbsp;</p>
            <div class="input-group">
              <span class="input-group-addon"><i class="icon_profile"></i></span>
              <input name="txtTenTK" type="text" autofocus class="form-control" id="txtTenTK" placeholder="Tên tài khoản">
          </div>
          <div class="input-group">
                <span class="input-group-addon"><i class="icon_key_alt"></i></span>
                <input name="txtMK" type="password" class="form-control" id="txtMK" placeholder="Mật khẩu">
          </div>
